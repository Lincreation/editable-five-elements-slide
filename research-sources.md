...
- [Help Center](https://www.genspark.ai/helpcenter) — 現在の機能名一覧、Super Agent
...
- [AI Image Generator](https://www.genspark.ai/tools/ai-image-generator) — 画像生成・参考画像・部分編集

## Google

- [Gemini in Sheets](https://support.google.com/docs/answer/16959434?hl=en) — シート作成・編集
- [Gemini in Slides](https://support.google.com/docs/answer/17111393?hl=en) — 編集可能なプレゼンテーション生成
- [Gemini in Drive](https://support.google.com/drive/answer/16963068?hl=en) — Drive内の情報利用
- [Gemini AppsとGoogle Workspaceの接続](https://support.google.com/gemini/answer/15229592?hl=ja) — 対象サービス、管理設定、確認上の注意

## AI Agent一般

- [Anthropic: Building effective agents](https://www.anthropic.com/engineering/building-effective-agents) — LLM、Tools、Agent loopの一般的な説明

## 資料で断定しないもの

- APHD契約プラン、Credits、利用可能Agent、出力形式
- 日本語UIのボタン名と位置
